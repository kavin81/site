            ...
            <div className="top_bar">
                <div className="footer_column connect">
                    ...
                    <div className="connect_icons">
                        {/* email */}
                        <a  data-umami-event="footer-connect" data-umami-event-platform="email"
                        ...
                        {/* github */}
                        <a
                            data-umami-event="footer-connect" data-umami-event-platform="github"
                        ...
                        {/* linkedin */}
                        <a
                            data-umami-event="footer-connect" data-umami-event-platform="linkedin"
                        ...
                        <a
                            data-umami-event="footer-connect" data-umami-event-platform="leetcode"
                            href={`https://leetcode.com/${siteConfig.connect.leetcode}`}
                        >
                            {/* leetcode */}
                            <svg
                                role="img"
                        ...
                        {/* instagram */}
                        <a
                            data-umami-event="footer-connect" data-umami-event-platform="instagram"
                            href={`https://instagram.com/${siteConfig.connect.instagram}`}
                        >
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 64 64"
